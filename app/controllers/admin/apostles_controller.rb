...
class Admin::ApostlesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Apostle: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Apostle: create, read, update, custom_action_for_an_item
  #
