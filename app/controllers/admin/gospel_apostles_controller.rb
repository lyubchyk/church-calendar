...
class Admin::GospelApostlesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     GospelApostle: create, read, update, destroy, custom_action
  #
  #   editor:
  #     GospelApostle: create, read, update, custom_action_for_an_item
  #
