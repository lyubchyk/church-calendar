...
class Admin::SermonsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Sermon: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Sermon: create, read, update, custom_action_for_an_item
  #
