...
class Admin::GospelsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Gospel: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Gospel: create, read, update, custom_action_for_an_item
  #
