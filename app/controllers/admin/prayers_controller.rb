...
class Admin::PrayersController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Prayer: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Prayer: create, read, update, custom_action_for_an_item
  #
