...
class Admin::TroparionsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Troparion: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Troparion: create, read, update, custom_action_for_an_item
  #
